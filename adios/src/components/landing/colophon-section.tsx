  ...
  return (
    ...
    >
      <div ref={headerRef} className="mb-16">
        ...
        <h2 className="mt-4 font-[var(--font-display)] text-5xl md:text-7xl tracking-tight">TECH STACK</h2>
      </div>
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            ...
            <li className="font-mono text-xs text-foreground/80">viem / wagmi</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            ...
            <li className="font-mono text-xs text-foreground/80">OpenRouter AI</li>
          </ul>
        </div>
      ...
      >
        ...
        <p className="font-mono text-[10px] text-muted-foreground">
          Autonomous Cross-Chain Yield Agent · Powered by LI.FI
        </p>
      </div>
    </section>
  )
